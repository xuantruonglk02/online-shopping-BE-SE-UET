...
router.post('/all', authMiddleware.verifyToken, (req, res) => {
 ...
 * productId
 */
router.post('/add', authMiddleware.verifyToken, (req, res) => {
  if (!req.body.productId) { return res.json({ success: 0 }); }
  if (isNaN(req.body.productId)) { return res.json({ success: 0 }); }
 ...
 * }]
 */
router.post('/update', authMiddleware.verifyToken, (req, res) => {
 ...
 * productId
 */
router.post('/remove', authMiddleware.verifyToken, (req, res) => {
